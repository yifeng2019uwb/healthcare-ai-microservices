...
CREATE TYPE record_type AS ENUM ('CONSULTATION', 'LAB_RESULT', 'IMAGING', 'PRESCRIPTION');
...
CREATE TYPE resource_type AS ENUM ('PATIENT', 'PROVIDER', 'APPOINTMENT', 'MEDICAL_RECORD');
