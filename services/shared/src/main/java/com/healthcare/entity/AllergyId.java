...
/**
 * Composite primary key for Allergy entity.
 * Maps to allergies table PK: (patient_id, encounter_id, code)
 */
@Embeddable
public class AllergyId implements Serializable {
    ...
    public AllergyId(UUID patientId, UUID encounterId, String code) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AllergyId)) return false;
        AllergyId that = (AllergyId) o;
